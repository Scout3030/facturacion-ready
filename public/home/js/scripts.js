...
(function($) {
    ...
    $("#requestForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            ...
            rformError();
            rsubmitMSG(false, "Por favor rellena todos los campos!");
        } else {
    ...
    function rformSuccess() {
        $("#requestForm")[0].reset();
        rsubmitMSG(true, "Gracias, estaremos en comunicación lo antes posible!");
    ...
    $("#contactForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            cformError();
            csubmitMSG(false, "Por favor rellena todos los!");
        } else {
            // everything looks good!
            event.preventDefault();
            csubmitForm();
